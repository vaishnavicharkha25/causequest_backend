...
interface NgoMasterCreationAttributes extends Optional<NgoMasterAttributes, 'NgoId' | 'Description' | 'ImageUrl' | 'Location' | 'Category' | 'Requirements' | 'TimePreferences' | 'Availability' | 'Rating' | 'VolunteersNeeded' | 'ContactEmail' | 'PhoneNumber' | 'Website' | 'ModifiedBy' | 'ModifiedOn'> {}
